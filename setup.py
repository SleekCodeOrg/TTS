...
if Version(python_version) < Version("3.9") or Version(python_version) >= Version("3.14"):
    raise RuntimeError("TTS requires python >= 3.9 and < 3.14 " "but your Python version is {}".format(sys.version))
